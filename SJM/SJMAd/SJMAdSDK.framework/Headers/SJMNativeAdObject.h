...
typedef NS_ENUM(NSInteger, SJMAdMaterialType) {
    SJMAdMaterialTypeUnkown      =       0,      // 未知
    SJMAdMaterialTypeVideo       =       1,      // 视频
    SJMAdMaterialTypeSingle      =       2,      // 单图
    SJMAdMaterialTypeAtlas       =       3,      // 多图
};
NS_ASSUME_NONNULL_BEGIN

@interface SJMNativeAdObject : NSObject

/**
 广告类型
 */
@property (nonatomic, readonly) SJMAdMaterialType materialType;
